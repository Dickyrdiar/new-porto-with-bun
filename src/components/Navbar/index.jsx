...
const NavbarSticky = () => {
  ...
  return (
    <div className="font-roboto w-full overflow-x-hidden shadow-lg">
      <Navbar className="top-0 z-10 h-[104px] rounded-none px-4 py-2 lg:px-8 lg:py-4 shadow-lg fixed w-full bg-white text-black">
        <div className="flex items-center justify-between text-blue-gray-900 p-4 lg:p-9 mt-[-20px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              >
                <FaLinkedin className="w-7 h-7 bg-white text-black" />
              </Button>
              <Button
                variant="text"
                size="sm"
              ...
              >
                <FaGithubSquare className="w-7 h-7 bg-white text-black" />
              </Button>
            </div>
